...
public class Agriculture {
    ...
    public Agriculture(Long id, String firstName, String lastName, ServicesEnum servicesEnum, Country country, String email) {
        this.id = id;
    ...
    public boolean equals(Object o) {
        ...
        return email == that.email && Objects.equals(id, that.id) && Objects.equals(firstName, that.firstName) && Objects.equals(lastName, that.lastName) && servicesEnum == that.servicesEnum && country == that.country;
    }
