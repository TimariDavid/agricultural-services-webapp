...
public class AgriculturalServiceImpl implements AgriculturalService {
    ...
    static {
        DATA_BASE.add(new Agriculture(1L, "Nagy", "Levente", ServicesEnum.BETAKARÍTÁS, Country.HAJDÚ_BIHAR, "nagy.levente@gmail.com"));
        DATA_BASE.add(new Agriculture(2L, "Kis", "Imre", ServicesEnum.BÁLÁZÁS, Country.BARANYA, "kis.imre@gmail.com"));
    }
